...
class DataSources(BaseSDK):
    ...
    def set_data_source_credentials(
        ...
        *,
        data_source_id: str,
        request_body: Union[
            List[models.DataSourceCredentialBase],
            List[models.DataSourceCredentialBaseTypedDict],
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> List[models.DataSourceCredential]:
        r"""Set Data Source Credentials
        ...
        request = models.SetDataSourceCredentialsRequest(
            data_source_id=data_source_id,
            request_body=utils.get_pydantic_model(
                request_body, List[models.DataSourceCredentialBase]
            ),
        )

        req = self._build_request(
            method="PUT",
            path="/data-sources/{data_source_id}/credentials",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="set_data_source_credentials",
                oauth2_scopes=None,
                security_source=None,
            ),
            request=req,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.DataSourceCredential], http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                errors.HTTPValidationErrorData, http_res
            )
    ...
    async def set_data_source_credentials_async(
        self,
        *,
        data_source_id: str,
        request_body: Union[
    ...
    def get_data_source_credentials(
        ...
        *,
        ...
        request = models.GetDataSourceCredentialsRequest(
            data_source_id=data_source_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="get_data_source_credentials",
                oauth2_scopes=None,
                security_source=None,
            ),
            request=req,
    ...
    async def get_data_source_credentials_async(
        self,
        *,
        data_source_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
