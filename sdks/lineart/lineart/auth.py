...
_DEFAULT_AUTH_URL = "https://engine.vulkan.software"
...
class LoginContext:
    ...
    def __init__(self, log_level: str = "INFO"):
        ...
        self.auth_server_url = os.getenv("VULKAN_AUTH_URL", _DEFAULT_AUTH_URL)
...
def base_login(ctx: LoginContext) -> None:
...
def _ensure_write(path: str, data: dict) -> None:
