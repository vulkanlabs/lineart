 ...
 */
export function instanceOfConfigurationVariablesBase(
  value: object,
): value is ConfigurationVariablesBase {
  if (!("name" in value) || value["name"] === undefined) return false;
  return true;
}

export function ConfigurationVariablesBaseFromJSON(
  json: any,
): ConfigurationVariablesBase {
  return ConfigurationVariablesBaseFromJSONTyped(json, false);
}

export function ConfigurationVariablesBaseFromJSONTyped(
  json: any,
...
export function ConfigurationVariablesBaseToJSON(
  json: any,
): ConfigurationVariablesBase {
  return ConfigurationVariablesBaseToJSONTyped(json, false);
}

export function ConfigurationVariablesBaseToJSONTyped(
  value?: ConfigurationVariablesBase | null,
