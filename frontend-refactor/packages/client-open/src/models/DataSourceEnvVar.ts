 ...
 */
export function instanceOfDataSourceEnvVar(value: object): value is DataSourceEnvVar {
...
export function DataSourceEnvVarFromJSONTyped(json: any, ignoreDiscriminator: boolean): DataSourceEnvVar {
    if (json == null) {
        return json;
    }
    return {
...
export function DataSourceEnvVarToJSONTyped(value?: DataSourceEnvVar | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
