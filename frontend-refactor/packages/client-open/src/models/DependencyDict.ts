 ...
 */
export function instanceOfDependencyDict(value: object): value is DependencyDict {
...
export function DependencyDictFromJSONTyped(json: any, ignoreDiscriminator: boolean): DependencyDict {
    if (json == null) {
        return json;
    }
    return {
...
export function DependencyDictToJSONTyped(value?: DependencyDict | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
