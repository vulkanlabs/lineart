 ...
 */
export function instanceOfConfigurationVariables(
  value: object,
): value is ConfigurationVariables {
  if (!("name" in value) || value["name"] === undefined) return false;
  return true;
}

export function ConfigurationVariablesFromJSON(
  json: any,
): ConfigurationVariables {
  return ConfigurationVariablesFromJSONTyped(json, false);
}

export function ConfigurationVariablesFromJSONTyped(
  json: any,
...
export function ConfigurationVariablesToJSON(
  json: any,
): ConfigurationVariables {
  return ConfigurationVariablesToJSONTyped(json, false);
}

export function ConfigurationVariablesToJSONTyped(
  value?: ConfigurationVariables | null,
