...
export function instanceOfBacktest(value: object): value is Backtest {
    if (!('backtest_id' in value) || value['backtest_id'] === undefined) return false;
    ...
    if (!('calculate_metrics' in value) || value['calculate_metrics'] === undefined) return false;
    if (!('target_column' in value) || value['target_column'] === undefined) return false;
    if (!('time_column' in value) || value['time_column'] === undefined) return false;
    if (!('group_by_columns' in value) || value['group_by_columns'] === undefined) return false;
...
export function BacktestFromJSONTyped(json: any, ignoreDiscriminator: boolean): Backtest {
    ...
    return {
        ...
        'group_by_columns': json['group_by_columns'] == null ? null : json['group_by_columns'],
