 ...
 */
export function instanceOfNodeDefinitionDict(value: object): value is NodeDefinitionDict {
...
export function NodeDefinitionDictFromJSONTyped(json: any, ignoreDiscriminator: boolean): NodeDefinitionDict {
    if (json == null) {
        return json;
    }
    return {
        ...
        'dependencies': json['dependencies'] == null ? undefined : (mapValues(json['dependencies'], DependencyDictFromJSON)),
...
export function NodeDefinitionDictToJSONTyped(value?: NodeDefinitionDict | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'dependencies': value['dependencies'] == null ? undefined : (mapValues(value['dependencies'], DependencyDictToJSON)),
