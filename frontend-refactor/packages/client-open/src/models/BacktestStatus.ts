 ...
 */
export function instanceOfBacktestStatus(value: object): value is BacktestStatus {
...
export function BacktestStatusToJSONTyped(value?: BacktestStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
