...
export function PolicyVersionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PolicyVersion {
    if (json == null) {
        return json;
    }
    return {
...
export function PolicyVersionToJSONTyped(value?: PolicyVersion | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
