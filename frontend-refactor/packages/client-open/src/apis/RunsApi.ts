...
export class RunsApi extends runtime.BaseAPI {
     ...
     * Get Run Data
     */
    async getRunDataRaw(requestParameters: GetRunDataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RunData>> {
        if (requestParameters['runId'] == null) {
            throw new runtime.RequiredError(
                'runId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RunDataFromJSON(jsonValue));
    }

    /**
     * Get Run Data
     */
    async getRunData(requestParameters: GetRunDataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RunData> {
     ...
     * Get Run Logs
     */
    async getRunLogsRaw(requestParameters: GetRunLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RunLogs>> {
        if (requestParameters['runId'] == null) {
            throw new runtime.RequiredError(
                'runId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RunLogsFromJSON(jsonValue));
    }

    /**
     * Get Run Logs
     */
    async getRunLogs(requestParameters: GetRunLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RunLogs> {
     ...
     * Publish Metadata
     */
    async publishMetadataRaw(requestParameters: PublishMetadataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['runId'] == null) {
            throw new runtime.RequiredError(
                'runId',
     ...
     * Publish Metadata
     */
    async publishMetadata(requestParameters: PublishMetadataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.publishMetadataRaw(requestParameters, initOverrides);
        return await response.value();
    }
