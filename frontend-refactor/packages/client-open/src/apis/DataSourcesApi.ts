...
export class DataSourcesApi extends runtime.BaseAPI {
     ...
     * Create Data Source
     */
    async createDataSourceRaw(requestParameters: CreateDataSourceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Create Data Source
     */
    async createDataSource(requestParameters: CreateDataSourceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     */
    async getCacheStatisticsRaw(requestParameters: GetCacheStatisticsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
        if (requestParameters['dataSourceId'] == null) {
            throw new runtime.RequiredError(
                'dataSourceId',
     ...
     * Get Cache Statistics
     */
    async getCacheStatistics(requestParameters: GetCacheStatisticsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: any; }> {
        const response = await this.getCacheStatisticsRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async getDataObjectRaw(requestParameters: GetDataObjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DataObject>> {
        ...
        urlPath = urlPath.replace(`{${"data_source_id"}}`, encodeURIComponent(String(requestParameters['dataSourceId'])));
        urlPath = urlPath.replace(`{${"data_object_id"}}`, encodeURIComponent(String(requestParameters['dataObjectId'])));
     ...
     */
    async getDataSourceEnvVariablesRaw(requestParameters: GetDataSourceEnvVariablesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<DataSourceEnvVar>>> {
        if (requestParameters['dataSourceId'] == null) {
            throw new runtime.RequiredError(
                'dataSourceId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(DataSourceEnvVarFromJSON));
    }

    /**
     * Get Data Source Env Variables
     */
    async getDataSourceEnvVariables(requestParameters: GetDataSourceEnvVariablesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<DataSourceEnvVar>> {
        const response = await this.getDataSourceEnvVariablesRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getDataSourceMetricsRaw(requestParameters: GetDataSourceMetricsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
        if (requestParameters['dataSourceId'] == null) {
            throw new runtime.RequiredError(
                'dataSourceId',
     ...
     * Get Data Source Metrics
     */
    async getDataSourceMetrics(requestParameters: GetDataSourceMetricsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: any; }> {
        const response = await this.getDataSourceMetricsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getDataSourceUsageRaw(requestParameters: GetDataSourceUsageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
        if (requestParameters['dataSourceId'] == null) {
            throw new runtime.RequiredError(
                'dataSourceId',
     ...
     * Get Data Source Usage
     */
    async getDataSourceUsage(requestParameters: GetDataSourceUsageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: any; }> {
        const response = await this.getDataSourceUsageRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * List Data Objects
     */
    async listDataObjectsRaw(requestParameters: ListDataObjectsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<DataObjectMetadata>>> {
        if (requestParameters['dataSourceId'] == null) {
            throw new runtime.RequiredError(
                'dataSourceId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(DataObjectMetadataFromJSON));
    }

    /**
     * List Data Objects
     */
    async listDataObjects(requestParameters: ListDataObjectsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<DataObjectMetadata>> {
     ...
     * List Data Sources
     */
    async listDataSourcesRaw(requestParameters: ListDataSourcesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<DataSource>>> {
        const queryParameters: any = {};
     ...
     * List Data Sources
     */
    async listDataSources(requestParameters: ListDataSourcesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<DataSource>> {
     ...
     */
    async setDataSourceEnvVariablesRaw(requestParameters: SetDataSourceEnvVariablesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['dataSourceId'] == null) {
            throw new runtime.RequiredError(
                'dataSourceId',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters['dataSourceEnvVarBase']!.map(DataSourceEnvVarBaseToJSON),
        }, initOverrides);
     ...
     * Set Data Source Env Variables
     */
    async setDataSourceEnvVariables(requestParameters: SetDataSourceEnvVariablesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.setDataSourceEnvVariablesRaw(requestParameters, initOverrides);
        return await response.value();
    }
