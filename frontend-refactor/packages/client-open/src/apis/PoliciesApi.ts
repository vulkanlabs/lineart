...
export class PoliciesApi extends runtime.BaseAPI {
     ...
     * Create Run Group
     */
    async createRunGroupRaw(requestParameters: CreateRunGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Create Run Group
     */
    async createRunGroup(requestParameters: CreateRunGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * Delete Policy
     */
    async deletePolicyRaw(requestParameters: DeletePolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['policyId'] == null) {
            throw new runtime.RequiredError(
                'policyId',
     ...
     * Delete Policy
     */
    async deletePolicy(requestParameters: DeletePolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * List Policies
     */
    async listPoliciesRaw(requestParameters: ListPoliciesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Policy>>> {
        const queryParameters: any = {};
     ...
     * List Policies
     */
    async listPolicies(requestParameters: ListPoliciesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Policy>> {
     ...
     * List Runs By Policy
     */
    async listRunsByPolicyRaw(requestParameters: ListRunsByPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Run>>> {
        if (requestParameters['policyId'] == null) {
            throw new runtime.RequiredError(
                'policyId',
     ...
     * List Runs By Policy
     */
    async listRunsByPolicy(requestParameters: ListRunsByPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Run>> {
        const response = await this.listRunsByPolicyRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listVersionsForPolicyRaw(requestParameters: ListVersionsForPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<PolicyVersion>>> {
        if (requestParameters['policyId'] == null) {
            throw new runtime.RequiredError(
                'policyId',
     ...
     * List Versions For Policy
     */
    async listVersionsForPolicy(requestParameters: ListVersionsForPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<PolicyVersion>> {
        const response = await this.listVersionsForPolicyRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async runDurationStatsByPolicyRaw(requestParameters: RunDurationStatsByPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<any>>> {
        if (requestParameters['policyId'] == null) {
            throw new runtime.RequiredError(
                'policyId',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: BodyRunDurationStatsByPolicyToJSON(requestParameters['bodyRunDurationStatsByPolicy']),
        }, initOverrides);
     ...
     * Run Duration Stats By Policy
     */
    async runDurationStatsByPolicy(requestParameters: RunDurationStatsByPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<any>> {
        const response = await this.runDurationStatsByPolicyRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async runDurationStatsByPolicyStatusRaw(requestParameters: RunDurationStatsByPolicyStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<any>>> {
        if (requestParameters['policyId'] == null) {
            throw new runtime.RequiredError(
                'policyId',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: BodyRunDurationStatsByPolicyStatusToJSON(requestParameters['bodyRunDurationStatsByPolicyStatus']),
        }, initOverrides);
     ...
     * Run Duration Stats By Policy Status
     */
    async runDurationStatsByPolicyStatus(requestParameters: RunDurationStatsByPolicyStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<any>> {
        const response = await this.runDurationStatsByPolicyStatusRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Runs By Policy
     */
    async runsByPolicyRaw(requestParameters: RunsByPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<any>>> {
        if (requestParameters['policyId'] == null) {
            throw new runtime.RequiredError(
                'policyId',
     ...
     * Runs By Policy
     */
    async runsByPolicy(requestParameters: RunsByPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<any>> {
        const response = await this.runsByPolicyRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async runsOutcomesByPolicyRaw(requestParameters: RunsOutcomesByPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<any>>> {
        if (requestParameters['policyId'] == null) {
            throw new runtime.RequiredError(
                'policyId',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: BodyRunsOutcomesByPolicyToJSON(requestParameters['bodyRunsOutcomesByPolicy']),
        }, initOverrides);
     ...
     * Runs Outcomes By Policy
     */
    async runsOutcomesByPolicy(requestParameters: RunsOutcomesByPolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<any>> {
        const response = await this.runsOutcomesByPolicyRaw(requestParameters, initOverrides);
        return await response.value();
    }
