    ...
    const errorPatterns = [
        {
            ...
            message:
                `Unable to ${operation} ${resourceType} due to network issues. ` +
        ...
        },
        {
            ...
            message:
                `The ${resourceType} you're trying to ${operation} was not found. ` +
...
export function handleActionError(operation: string, resourceType: string, error: unknown): never {
