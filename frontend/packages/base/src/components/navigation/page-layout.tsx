...
export function Sidebar({
    ...
    // Determine sidebar width classes based on configuration
    const sidebarWidthClasses = config.useResponsiveBreakpoints
        ? isExpanded
                    ...
                    >
                        <div className="ml-6">
                            {sectionProps.disabled ? (
                                ...
                                <Link
                                    href={
                                        sectionProps.skipProjectParam || !config.withProject
                                            ? sectionProps.path
                                            : config.withProject(
                                                  sectionProps.path,
