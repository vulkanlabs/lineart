...
export interface PolicyResourcesEnvironmentVariablesConfig {
    policyVersion: any;
    variables: EnvironmentVariablesEditorProps["variables"];
    setPolicyVersionVariables: (policyVersionId: string, variables: any[]) => Promise<void>;
}

export interface PolicyResourcesDataSourcesTableConfig {
    sources: any[];
}
...
export function PolicyResourcesEnvironmentVariables({
    ...
    return (
        <EnvironmentVariablesEditor
            ...
            onSave={async (updatedVariables: any[]) => {
...
const DataSourceTableColumns: ColumnDef<any>[] = [
    {
        accessorKey: "link",
        header: "",
        cell: ({ row }) => (
