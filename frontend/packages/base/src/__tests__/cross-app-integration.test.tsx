...
describe('Cross-App Configuration Compatibility', () => {
    describe('Configuration Interoperability', () => {
        ...
        it('should maintain type safety across configurations', () => {
            ...
            expect(() => render(<BaseAppWorkflowFrame {...globalProps} config={GLOBAL_SCOPE_CONFIG} />)).not.toThrow()
            expect(() => render(<BaseAppWorkflowFrame {...projectProps} config={PROJECT_SCOPE_CONFIG} />)).not.toThrow()
        })
    })
