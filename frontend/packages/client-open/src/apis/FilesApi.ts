...
export class FilesApi extends runtime.BaseAPI {
   ...
   * List Uploaded Files
   */
  async listUploadedFilesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<UploadedFile>>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(UploadedFileFromJSON),
    );
  }
  ...
  async uploadFileRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UploadedFile>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UploadedFileFromJSON(jsonValue),
    );
  }
