...
export class BackfillsApi extends runtime.BaseAPI {
   ...
   * Get Backfill
   */
  async getBackfillRaw(
    requestParameters: GetBackfillRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Backfill>> {
    ...
    urlPath = urlPath.replace(
      `{${"backfill_id"}}`,
      encodeURIComponent(String(requestParameters["backfillId"])),
    );
  ...
  async getBackfill(
    ...
    const response = await this.getBackfillRaw(
      requestParameters,
      initOverrides,
    );
   ...
   */
  async getBackfillResultsRaw(
    requestParameters: GetBackfillResultsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * Get Backfill Results
   */
  async getBackfillResults(
    requestParameters: GetBackfillResultsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<any> {
    const response = await this.getBackfillResultsRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Get Backfill Status
   */
  async getBackfillStatusRaw(
    requestParameters: GetBackfillStatusRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BackfillStatus>> {
    if (requestParameters["backfillId"] == null) {
      throw new runtime.RequiredError(
        "backfillId",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      BackfillStatusFromJSON(jsonValue),
    );
  }
  ...
  async getBackfillStatus(
    ...
    const response = await this.getBackfillStatusRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * List Backfills
   */
  async listBackfillsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<Backfill>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(BackfillFromJSON),
    );
  }
   ...
   * Update Backfill
   */
  async updateBackfillRaw(
    requestParameters: UpdateBackfillRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<any>> {
    if (requestParameters["backfillId"] == null) {
      throw new runtime.RequiredError(
  ...
  async updateBackfill(
    ...
    const response = await this.updateBackfillRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
