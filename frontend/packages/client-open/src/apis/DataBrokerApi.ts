...
export class DataBrokerApi extends runtime.BaseAPI {
   ...
   */
  async requestDataFromBrokerRaw(
    requestParameters: RequestDataFromBrokerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<DataBrokerResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      DataBrokerResponseFromJSON(jsonValue),
    );
  }
   ...
   * Request Data From Broker
   */
  async requestDataFromBroker(
    requestParameters: RequestDataFromBrokerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<DataBrokerResponse> {
    const response = await this.requestDataFromBrokerRaw(
      requestParameters,
      initOverrides,
    );
