 ...
 */
export function instanceOfPolicyVersionBase(
  value: object,
): value is PolicyVersionBase {
...
export function PolicyVersionBaseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    input_schema:
      json["input_schema"] == null ? undefined : json["input_schema"],
    requirements:
...
export function PolicyVersionBaseToJSONTyped(
  value?: PolicyVersionBase | null,
