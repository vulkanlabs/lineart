 ...
 */
export function instanceOfBackfillStatus(
  value: object,
): value is BackfillStatus {
...
export function BackfillStatusFromJSONTyped(
  json: any,
...
export function BackfillStatusToJSONTyped(
  value?: BackfillStatus | null,
