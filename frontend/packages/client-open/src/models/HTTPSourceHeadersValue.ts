 ...
 */
export function instanceOfHTTPSourceHeadersValue(
  value: object,
): value is HTTPSourceHeadersValue {
  if (!("env" in value) || value["env"] === undefined) return false;
  if (!("param" in value) || value["param"] === undefined) return false;
  return true;
}

export function HTTPSourceHeadersValueFromJSON(
  json: any,
): HTTPSourceHeadersValue {
  return HTTPSourceHeadersValueFromJSONTyped(json, false);
}

export function HTTPSourceHeadersValueFromJSONTyped(
  json: any,
...
export function HTTPSourceHeadersValueToJSON(
  json: any,
): HTTPSourceHeadersValue {
  return HTTPSourceHeadersValueToJSONTyped(json, false);
}

export function HTTPSourceHeadersValueToJSONTyped(
  value?: HTTPSourceHeadersValue | null,
