 ...
 */
export function instanceOfPolicyDefinitionDictInput(
  value: object,
): value is PolicyDefinitionDictInput {
...
export function PolicyDefinitionDictInputFromJSON(
  json: any,
): PolicyDefinitionDictInput {
  return PolicyDefinitionDictInputFromJSONTyped(json, false);
}

export function PolicyDefinitionDictInputFromJSONTyped(
  json: any,
...
export function PolicyDefinitionDictInputToJSON(
  json: any,
): PolicyDefinitionDictInput {
  return PolicyDefinitionDictInputToJSONTyped(json, false);
}

export function PolicyDefinitionDictInputToJSONTyped(
  value?: PolicyDefinitionDictInput | null,
